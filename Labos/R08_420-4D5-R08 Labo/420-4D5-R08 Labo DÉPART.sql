...
--     Partie 3:  Exécutez votre procédure avec les requêtes AVANT et APRÈS l'exécution de votre procédure pour voir le contenu de la table Client et de la table ClientSansCommande
